...
while True:
    ...
    if first == second:
        ...
        print(f"Type : A Name : {first['name']},Description : {first['description']}, Country : {first['country']}")
        print(vs)
        print(f"Type : B Name : {second['name']},Description : {second['description']}, Country : {second['country']}")
